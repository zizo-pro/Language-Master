...
CREATE TABLE `adjectives` (
  ...
  `male` varchar(40) NOT NULL,
  `female` varchar(40) NOT NULL,
...
INSERT INTO `adjectives` VALUES ('Schnell','Fast','Schnell','Schnelle','Schnelles','Adjective','Das auto ist schnell',1);
